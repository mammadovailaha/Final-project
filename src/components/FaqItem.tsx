    ...
    >
      ...
      >
        <div className="w-[95%] h-full flex justify-between items-center">
          ...
          <div className="cursor-pointer text-2xl text-black  transition-colors duration-700 ease-in-out">
            {isOpen ? <IoIosRemoveCircleOutline className="text-lg md:text-2xl" /> : <IoIosAddCircleOutline className="text-lg md:text-2xl" />}
          </div>
        </div>
      </div>
      {isOpen && (
        <div className="w-full flex justify-center items-center px-5 py-4 text-black transition-all duration-700 ease-in-out">
