...
export const ChatButton:React.FC<chatButtonProps> = ({ isOpen, onClick }) => (
  <button
    onClick={onClick}
    className={`fixed z-[1001] bottom-8 right-8 w-12 h-12 md:w-16 md:h-16 rounded-full shadow-xl transition-all flex items-center justify-center cursor-pointer ${
