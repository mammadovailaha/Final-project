...
const StudyAbroadCard: React.FC<Props> = ({key,src, alt, country }) => {
  return (
    ...
    boxShadow: "-2px 6px 22px 3px rgba(0,0,0,0.25)"
      ...
      <div className="w-full h-48 md:h-42 bg-white hover:bg-[#22C8BA] transition-all duration-500 rounded-br-sm rounded-bl-sm flex flex-col justify-center items-center gap-2.5">
