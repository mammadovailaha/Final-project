...
const StudyAbroadCard: React.FC<Props> = ({key,src, alt, country }) => {
  return (
    <div className="w-50 h-40 md:w-56 md:h-44  bg-[#4b6043] rounded-[7px] flex flex-col justify-end items-center"   style={{
    boxShadow: "-2px 6px 22px 3px rgba(0,0,0,0.25)"
  }}>
      <div className="w-full h-38 md:h-42 bg-white  transition-all duration-500 rounded-br-sm rounded-bl-sm flex flex-col justify-center items-center gap-2.5">
