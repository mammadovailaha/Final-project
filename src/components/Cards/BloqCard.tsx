...
const BloqCard:React.FC<Props> = ({src, alt, key, text}) => {
  return (
    <div className='w-94 h-40 md:w-125 md:h-60 flex justify-center items-center rounded-tl-[80px] md:rounded-tl-[100px] rounded-br-[80px] md:rounded-br-[100px] rounded-tr-[80px]   md:rounded-tr-[100px]  overflow-hidden bg-[#f3f2eb] shadow-xl hover:shadow-2xl transition-shadow duration-300 group '>
      <div className=' w-20 md:w-60 h-20 md:h-45 rounded-tl-[100px] rounded-bl-[5px] rounded-br-[100px] rounded-tr-[100px] overflow-hidden  ' key={key}>
