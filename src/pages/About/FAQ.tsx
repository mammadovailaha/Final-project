...
const FAQ = () => {
  ...
  return (
    <div  style={{padding:"20px"}} className="w-full  flex flex-col lg:flex-row justify-center items-center lg:items-start bg-white  gap-10 ">
      ...
      <div className="w-[95%] lg:w-[90%] flex flex-col items-center justify-center gap-5 px-5 md:px-10">
        {faqData.map((item) => (
          <FaqItem
            key={item.id}
            id={item.id}
