...
import { useGetAllPartnersQuery } from "../../../services/features/partners";
...
const Partners = () => {
  const { data: partners = [], error, isLoading } = useGetAllPartnersQuery();
  console.log("partners", partners);

  if (isLoading) return <p>Loading...</p>;
  if (error) {
    console.error("Partners API Error:", error);
    return <p>Error loading partners!</p>;
  }
