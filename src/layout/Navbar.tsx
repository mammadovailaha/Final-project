...
export default function Navbar() {
  ...
  const XidmetlerItems = [
    { label: "Şahmat kursları", path: "/course/course-detail/:id" },
    { label: "Sürücülük kursları", path: "/course/course-detail/:id" },
    { label: "Mühasibatlıq kursları", path: "/course/course-detail/:id" },
    { label: "Kompüter  kursları", path: "/course/course-detail/:id" },
    { label: "Xarici dil kursları", path: "/course/course-detail/:id" },
    { label: "YÖS və ALES hazırlığı", path: "/course/course-detail/:id" },
    { label: "Dövlət qulluğuna hazırlıq", path: "/course/course-detail/:id" },
    { label: "MİQ hazırlığı", path: "/course/course-detail/:id" },
    { label: "Abituriyent  hazırlığı", path: "/course/course-detail/:id" },
    { label: "Magistratura hazırlığı", path: "/course/course-detail/:id" },
    { label: "Kiber təhlükəsizlik kursları", path: "/course/course-detail/:id" },
    { label: "SQL kursları", path: "/course/course-detail/:id" },
    { label: "Power BI kursları", path: "/course/course-detail/:id" },
    { label: "SMM kursları", path: "/course/course-detail/:id" },
